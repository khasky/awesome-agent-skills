...
| Skill | What it does |
| --- | --- |
| [BulkPublish social media content skills](https://github.com/azeemkafridi/bulkpublish-api/tree/main/skills/social-media-content-skills) | Reusable, platform-aware skills for planning, adapting, reviewing, scheduling, and publishing social media content from AI agents through BulkPublish |
