...
- Address the reader as "you" and make them the actor: "you see", "you can spot", "so you can build a strategy on hard evidence".
- Restate a question heading as the first clause of the answer. "Why check backlinks?" → "You should check backlinks because…"
- Answer completely in the first sentence, then elaborate.
- Attach a number to every claim. Prefer exact and dated: "moved to position 2", "from 13% to 32%", "increased 269% year over year".
- State the boundary of a claim out loud: "Treat search volume as the upper limit of opportunity", "directional rather than exact", "Treat that as a hypothesis, not a finding."
- Name what did not work, what was not tested, and what the competitor does better.
- Use contractions everywhere except press releases and legal.
- Use the negate-then-assert beat: "Coverage was cheap. Credibility wasn't." / "The pages that get cited aren't lucky. They're structured."
- Use the era pivot when framing change: "Rankings used to mean one blue-link page. Now they mean answers, citations, and mentions."
- Name competitors and third-party tools plainly and neutrally.
- Close marketing pages with a specific action verb, never "Learn more".

Don't

- Don't open with scene-setting ("In today's fast-paced digital landscape", "It's no secret that", "Let's dive in"). Open on the claim.
- Don't use analogies, idioms as explanation, or metaphors. Write "AI visibility determines whether you get found", not "a lighthouse guiding buyers through the fog."
- Don't hedge with adverbs (*arguably, perhaps, somewhat, quite, very, really*). State the claim, then state its limit.
- Don't use hype vocabulary (list below). Don't use exclamation marks outside Academy copy.
- Don't use emoji. Zero across all 2026 pages.
- Don't bold for emphasis mid-sentence. Bold is structural only.
- Don't disparage competitors. List what you have; never what they lack.
- Don't use "we" for solidarity ("we believe", "we're passionate about"). Those sentences do not exist in this corpus.
- Don't write "click here" or bare URLs.
- Don't spell out numbers. Digits, always.
...
- `Turn X into Y` — "Turn keyword gaps into roadmaps", "Turn SEO insights into board-ready decisions".
- `X-ready` compounds — board-ready, SERP-ready, executive-ready, press-ready, ready-to-rank, AI-ready.
- `X, not Y` — "on data, not assumptions", "built for marketers, not analysts", "hard evidence — not guesswork".
...
- Sentences: 10–22 words. One subordinate clause maximum. Press releases are the deliberate exception (30–65 words, appositive-stacked); legal runs 40–70 with three-deep subordination.
- Paragraphs: one to three sentences, very often exactly one. Single-sentence paragraphs are used as structural beats: "The audit took one afternoon." / "And that was the easy part." / "The second test said otherwise." No paragraph exceeds five sentences.
- Fragments are house style in two forms. Triadic headline fragments — "Get found. Get chosen. Stay listed." / "Spot the gap. Close the gap. Prove it closed." / "Two weeks. One workflow. Built for teams that report up." And sentence-initial conjunctions splitting one thought across two sentences — "And flag which pages to fix first." / "Which makes the title tag a good starting point." / "So, I reran the report a week later."
- Em dash is the house connector, used for the reversal and the gloss: "The demo went perfectly — the launch didn't." Spacing is inconsistent in the source (spaced on 2026 brand copy, unspaced in hero strings and pre-2026 blog; press releases use a spaced en dash). Pick spaced em dash and hold it.
- Colon stages the payoff: "The problem is simple: Most teams measure rankings, not answers." Blog prose capitalizes after the colon; keep that.
- Colon-then-bullets is the dominant structural move for any list.
- Rhetorical question then terse answer: "But does a higher score mean more traffic? / Not by itself."
- Parallel three- and four-beat lists: "track, optimize, and win", "recommended, cited, compared, or forgotten".
- `The takeaway:` opens the closing paragraph of each finding in study posts.
- Oxford comma is used most of the time but not enforced. Curly quotes throughout. `&` inside headings and nav labels. No semicolons in marketing copy.

## Structure

Landing / solution / feature page — a fixed eight-slot template:

1. lowercase kicker naming the audience or goal ("Semrush for agencies", "grow search visibility")
2. imperative or antithesis H1 ("Be found wherever customers search", "Your rivals have an agency. You have the data.")
3. one-sentence subhead naming mechanism *and* outcome, usually carrying a number
4. dual CTA, always this order: Try free for 7 days then Get a demo
5. one customer quote, unpolished, with *Name / Title, Company* underneath
6. 4–7 benefit blocks: imperative-verb heading → 1–2 sentences → a 2–4-word micro-CTA that restates the verb ("Research competitors", "Track rankings", "Check backlinks")
...
- Bulleted lists carry the body. Items are noun phrases or imperative clauses, 4–10 words, no terminal punctuation. When an item needs a gloss, use `Term: explanation` — "Authority Score: Semrush's proprietary measure of a domain's SEO strength". (The source is inconsistent about periods on two-sentence items; pick one and hold it.)
- Numbered lists for procedure and ranking. Free-tool steps are numbered bare ("1 Enter your text").
- Bold is structural, not emphatic — bullet labels and card titles only. No inline bold for emphasis, no italics.
- Tables only for head-to-head comparison (tool matrices, pricing grids, metric/what-it-answers pairs).
- Links are descriptive. Inline anchors on tool names inside blog prose; on marketing pages links are standalone action strings on their own line. CTA verbs are specific to the action — Check Backlinks, Find Competitors, Simulate SERP, Reveal Competitor Secrets, Download Full Study, See workflow, Read now. "Learn more" is rare.
- Zero emoji. They appear only in 2024-vintage Content Hub posts (🔥 / ➡️ as section markers, 👍/👎 as table headers) and one Academy 😉. Treat as a legacy artifact, not current voice.
- Exclamation marks are confined to Academy and partner landing pages. Zero in blog, KB, product, pricing, press, legal.
- Stat blocks render as a bare numeral line plus a one-line gloss, and the gloss is where the one permitted brag or wink lives: "More keywords means more ways to win." / "Your (secret) market insights superpower."
- Metadata: blog cards carry *Author · N min read · Date*, read time before date; long posts add `Contributors:` and a "reviewed by" credit. Dates in full US style ("July 30, 2026").
- Heading case is mid-migration in the source: Title Case with bracketed qualifiers on 2024–2025 content ("The 10 Best AI Writing Tools to Try in 2024 [Tested Manually]"), sentence case on 2026 content ("Link building for SEO: What works in 2026"). Press-release headlines stay Title Case in both eras. For new writing, use sentence case — that is the direction of travel.
...
| --- | --- | --- | --- | --- |
| Landing / solution / feature | you | yes | one wink per page max | Rigid template, fragment triads, stat band |
| Blog (all four sub-types) | you; `we` for methodology and own results; `I` in bylined posts | yes | none | One-sentence paragraphs, numbers, disclosed limitations |
| Free tool | you | yes | none | Answer-first explainers, plainly stated upsell |
| Knowledge base | you | no | none | Affect-free, procedural, exact per-tier numbers |
| Academy | you / let's | yes | yes — exclamations, parentheticals, self-deprecation | The upper bound of informality. Anything this warm elsewhere is off-voice |
| Press release / legal | third person | no | none | Long sentences, boilerplate appositives, no "you" |

Pronoun rules that hold across all genres:

- `you` — the default subject everywhere except press and legal.
...
- Every fact, figure, date, name, product name, version, price, URL, and code sample. Never invent a statistic to satisfy the "attach a number" rule — if the source has no number, restructure the sentence instead of fabricating one.
- The source's language. Translate nothing.
- The order of ideas and the argument's logic. This is a voice transform, not a restructure — unless the target genre's template (above) explicitly calls for a section reorder, in which case move whole blocks, never claims.
- Headings' meaning. Rephrase a heading into question form or imperative form, but do not change what it is about.
- Any legally load-bearing wording, disclaimers, warnings, licence text, and attributions.

Replace:

- Voice → second person, present tense, reader-as-operator. Convert passive constructions and third-person abstractions ("users can configure…") into direct address ("Configure…" / "You can configure…"). Keep third person only if the piece is a press release or legal text.
- Openings → delete scene-setting, delete "In this article we'll…", delete throat-clearing. Open on the claim or the definition. Under each heading, the first sentence restates the heading as an answer.
- Rhythm → break long sentences at the conjunction. Target 10–22 words. Split paragraphs so most run one to three sentences. Use a single-sentence paragraph wherever the source pivots.
- Lexicon → swap every hype word for a plain one (see the banned list). Swap metaphor and analogy for the literal statement. Swap "rank" for "show up" where AI search is in scope. Where the source concedes something, keep the concession and sharpen it — candor is the voice.
- Formatting → convert dense explanatory prose into `Term: explanation` bullets where the source is enumerating. Strip emphasis bold; keep bold only on bullet labels. Remove emoji. Remove exclamation marks unless the piece is Academy-style course copy.
- Closings → end on an action, not a summary. If the source has a call to action, make its verb specific to the action.

Imitation strictness:

- The answer-first rule (restate the heading, answer completely in sentence one) and the pronoun rules are hard — apply them to every sentence, no exceptions outside press/legal.
- The genre templates in Structure are hard for marketing and free-tool pages (the eight-slot landing skeleton, the FAQ echo, the dual CTA order) and advisory for blog and docs — follow the skeleton where the source already has those parts; do not manufacture a customer quote, a stat band, or an FAQ that the source does not support.
- The fragment triads, the era pivot, and the negate-then-assert beat are flavour, not quota. One or two per page. Overusing them reads as parody.
- Never copy the synthetic samples' *content* into a rewrite. They are cadence references only.
