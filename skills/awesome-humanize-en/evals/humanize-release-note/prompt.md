---
name: humanize-release-note
description: awesome-humanize-en strips AI flavor from a release note and keeps every fact
...
This release note reads AI-generated. Remove the AI voice but keep every fact. Reply with only the rewritten note, nothing else.
