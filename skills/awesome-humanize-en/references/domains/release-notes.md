...
| Tell | Fix |
|---|---|
| Marketing inflation: "We're thrilled to announce", "powerful new features", "seamless experience", "supercharge your workflow" | State what changed. The feature is the news; enthusiasm is not |
| Benefit claims with no mechanism: "improved performance", "enhanced stability" | The number or the change itself: "cold start 1.8s to 0.4s", "fixed a race in the retry queue (#412)" |
...
5. Humor and voice are allowed if the repo's history has them; never inject them fresh into a repo that does not.
