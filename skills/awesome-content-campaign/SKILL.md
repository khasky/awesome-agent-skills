...
- No Tier 1 vocabulary and no phrase from the catalog that is out regardless of density — both in `awesome-humanize-en`'s `references/lexicon.md`, the inventory every skill here shares. No "it's not X, it's Y" contrast frames, no forced rule-of-three, no negative-parallelism countdowns ("No X. No Y. Just Z.").
