...
description: "Read-only audit of a landing page's conversion structure: primary CTA, form friction, message match, trust elements, above-the-fold value. Use when a page is not converting."
license: MIT
metadata:
  author: Khasky
